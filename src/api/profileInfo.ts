...
class ProfileClient {
  ...
  public async addUpdateProfile(
    ...
    const runtimeArgs = RuntimeArgs.fromMap({
      ...
      evm_wallet: CLValueBuilder.string(evm_wallet),
  ...
  public async removeProfile(address: CLPublicKey, deploySender: CLPublicKey) {
    const runtimeArgs = RuntimeArgs.fromMap({
      address: CLValueBuilder.key(
        CLValueBuilder.byteArray(address.toAccountHash())
      ),
