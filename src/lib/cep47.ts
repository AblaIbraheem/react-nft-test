...
//xoxoxoxoxoxoxox
  public async balanceOf(account: CLPublicKey) {
    console.log(this.contractClient)
    const result = await this.contractClient.queryContractDictionary(
      'balances',
  ...
  public async mint(
    ...
    const runtimeArgs = RuntimeArgs.fromMap({
      ...
      // is_approved: CLValueBuilder.bool(true),
      hasReceipt: CLValueBuilder.bool(hasReceipt),
      currency: CLValueBuilder.string(currency),
      campaign: CLValueBuilder.u256(parseInt(campaign)),
  ...
  public async createCampaign(
    ...
    const runtimeArgs = RuntimeArgs.fromMap({
      ...
      approve_all: CLValueBuilder.bool(approve_all),
    });
  ...
  public async setIsApproveAllCampaign(
    campaign_id: string,
    status: boolean,
    paymentAmount: string,
    deploySender: CLPublicKey,
